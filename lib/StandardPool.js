...
StandardPool = Pool.extend(
    ...
    _.extend({}, {
        ...
        call: function(method, params) {
            ...
            assert(_.isUndefined(params) || _.isArray(params), "Params is expected to be an Array");
    ...
    {
        DEFAULTS: {
            path:         path.resolve(__dirname + "/../bin/lib.js"),
            ping:         10000,
            kill_timeout: 60000,
            kill_after:   3
        }
